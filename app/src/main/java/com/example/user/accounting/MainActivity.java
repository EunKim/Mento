...
public class MainActivity extends AppCompatActivity {
   ...
   /* private Context CONTEXT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnnewcustomer = (Button)findViewById(R.id.btnnew) ;
        ...
        btnconfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // info2.setText("PWD : " + password.getText());
                ...
                new httpTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "login_do_get.php?id="+reid+"pwd="+repwd, "");
        ...
        btnnewcustomer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent newcustomer = new Intent(MainActivity.this, NewCustomerActivity.class);
